...
function TaskCard({ task, onClick }: any) {
  return (
    <motion.div 
      draggable 
      // Usamos onDragStartCapture para ignorar o conflito com o Framer Motion
    ...
    >
      {/* Indicador de Prioridade Crítica */}
      ...
      <div className="flex justify-between items-start mb-4">
        ...
        <span className="text-[10px] font-mono font-black text-blue-400 bg-blue-500/5 px-2 py-0.5 rounded border border-blue-500/10 shadow-inner">
          {task.score} SC
        </span>
      </div>
